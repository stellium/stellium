...
/**
 * Get a single client based on it's ID
 */
router.get('/:modelId', function(req, res, next) {
    Lead.findById(req.params['modelId'], function(err, user) {
        res.send(user);
    });
});
...
router.post('/', function(req, res, next) {
    Lead.create(req.body, function(err, user) {
...
/**
 * Updates a client based on it's id
 */
